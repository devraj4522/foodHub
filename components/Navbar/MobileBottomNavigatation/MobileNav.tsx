     ...
     className=" sm:hidden fixed  left-0 h-16 bg-[#f2f2f2] shadow-lg z-50 w-full " maxWidth="full" isBordered>
      <NavbarContent className="flex justify-between w-full px-2" justify="center">
        <NavbarItem className="flex-1">
          <Link href="/" className={`flex justify-center items-center w-full h-full ${isActive("/") ? "text-[#b2a500]" : "text-black"}`}>
        ...
        <NavbarItem className="flex-1">
          <Link href="/search" className={`flex justify-center items-center w-full h-full ${isActive("/search") ? "text-[#EFDCB1]" : "text-black"}`}>
        ...
        <NavbarItem className="flex-1">
          <Link href="#" className="flex justify-center items-center w-full h-full text-black relative" onClick={() => setShowCart(!showCart)}>
